...
<body style="user-select: none;">
   ...
   <div class="grid-1">
      <div class="sidebar">
         <div class="logo-brand pl-35">
            <img onclick="changeTo_tabCaNhan()" src="{{url('assets/img/tunesource.png')}}" width="100"
   ...
   <div class="grid-2">
      ...
      <div class="header-top">
         ...
         <div class="user-function">
            ...
            <a href="#" class="button5 user">
               ...
               <span>Welcome Back, Hoang Anh</span>
            </a>
      ...
      <div id="tabKhamPha">
         ...
         <div class="playlist--hot-2022 white">
            <div class="playlist--title">
               <h2>Merry Christmas is coming in 2023 </h2>
            </div>
            <div class="playlist--carousel">
               <div class="pl-element">
                  <div class="element--head">
                  ...
                  <div class="element--title">
                     <h3>Timeless Christmas songs in year</h3>
                     <p>Top Christmas songs in 2023</p>
                  </div>
               </div>
               <div class="pl-element">
                  <div class="element--head">
               ...
               <div class="pl-element">
                  ...
                  <div class="element--title">
                     <h3>USUK Christmas POP Music</h3>
                     <p>The best Christmas songs of 2023</p>
                  </div>
               </div>
               <div class="pl-element">
                  ...
                  <div class="element--title">
                     <h3>Heartwarming winter love songs</h3>
                     <p>The best Christmas songs of 2023</p>
                  </div>
               </div>
               <div class="pl-element">
