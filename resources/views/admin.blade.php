...
<body style="user-select: none;">
   ...
   <div class="grid-2">
      ...
      <!-- Start trang cá nhân -->
      <div id="tabCaNhan">
         <h1 style="color: white">Welcome you to Admin Panel</h1>
         <table class="table table_admin table-bordered" style="width:98%;">
            ...
            <tbody @foreach ($musics as $key=> $item)
               <tr>
                  ...
                  <td>
                     <a onclick="return confirm('Do you really want to remove this song ?')" href="{{route('admin.delete', ['id' => $item->id])}}" class="btn btn-danger btn-sm">Remove</a>
                  </td>
               </tr>
